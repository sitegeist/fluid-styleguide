...
/******/ 	return __webpack_require__(__webpack_require__.s = "./Resources/Private/Javascript/Styleguide.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./Resources/Private/Components/Atom/StyleguideRefreshIFrame/StyleguideRefreshIFrame.js":
/*!**********************************************************************************************!*\
  !*** ./Resources/Private/Components/Atom/StyleguideRefreshIFrame/StyleguideRefreshIFrame.js ***!
  \**********************************************************************************************/
...
var button = document.getElementById('styleguideRefreshIframe_button');
...
/***/ "./Resources/Private/Components/Atom/StyleguideScrollTop/StyleguideScrollTop.js":
/*!**************************************************************************************!*\
  !*** ./Resources/Private/Components/Atom/StyleguideScrollTop/StyleguideScrollTop.js ***!
  \**************************************************************************************/
/*! no exports provided */
...
/* harmony import */ var _Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../Javascript/Utils */ "./Resources/Private/Javascript/Utils.js");


var StyleguideScrollTop = function StyleguideScrollTop(el) {
  ...
  Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["find"])('div', el).addEventListener('click', function () {
    window.scrollTo({
      top: 0,
      behavior: 'smooth'
    });
...
Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["register"])('StyleguideScrollTop', StyleguideScrollTop);

/***/ }),

/***/ "./Resources/Private/Components/Atom/StyleguideSelect/StyleguideSelect.js":
/*!********************************************************************************!*\
  !*** ./Resources/Private/Components/Atom/StyleguideSelect/StyleguideSelect.js ***!
  \********************************************************************************/
/*! no exports provided */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../Javascript/Utils */ "./Resources/Private/Javascript/Utils.js");
/* harmony import */ var _StyleguideSelectHelper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./StyleguideSelectHelper */ "./Resources/Private/Components/Atom/StyleguideSelect/StyleguideSelectHelper.js");



var StyleguideSelect = function StyleguideSelect(el) {
  if (el) {
    // options
    var autoSuggest = el.dataset.autosuggest ? el.dataset.autosuggest : false;
    var submitFormOnSelect = el.dataset.submitformonselect ? el.dataset.submitformonselect : false;
    var classPrefix = 'styleguideSelect';
    var nativeSelectElement = el.getElementsByTagName('select')[0];
    var selectLabel = _StyleguideSelectHelper__WEBPACK_IMPORTED_MODULE_1__["StyleguideSelectHelper"].buildFormCustomSelectLabel(nativeSelectElement, autoSuggest);
    var select = _StyleguideSelectHelper__WEBPACK_IMPORTED_MODULE_1__["StyleguideSelectHelper"].buildFormCustomSelect(nativeSelectElement, submitFormOnSelect);
    var fakeOptions = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["findAll"])('div', select);
    var autoSuggestInput = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["find"])('input', selectLabel); // append custom select and custom select label

    el.appendChild(selectLabel);
    el.appendChild(select);
    var preSelected; // handle auto suggest if set in options

    if (autoSuggest && autoSuggestInput) {
      autoSuggestInput.addEventListener('input', function (e) {
        _StyleguideSelectHelper__WEBPACK_IMPORTED_MODULE_1__["StyleguideSelectHelper"].handleAutoSuggestInput(fakeOptions, select, e.currentTarget);
      });
      autoSuggestInput.addEventListener('focus', function (e) {
        e.currentTarget.value = '';
      });
      autoSuggestInput.addEventListener('blur', function (e) {
        _StyleguideSelectHelper__WEBPACK_IMPORTED_MODULE_1__["StyleguideSelectHelper"].handleAutoSuggestBlur(fakeOptions, select, e.currentTarget);
      });
      preSelected = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["findAll"])('div', select).find(function (h) {
        return h.innerHTML === Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["find"])('input', selectLabel).value.trim();
      });
    } else {
      // preselect option
      preSelected = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["findAll"])('div', select).find(function (h) {
        return h.innerHTML === selectLabel.textContent;
      });
    }

    if (typeof preSelected !== 'undefined') {
      preSelected.classList.add("".concat(classPrefix, "EqualSelected"));
    ...
    selectLabel.addEventListener('click', function (e) {
      ...
      _StyleguideSelectHelper__WEBPACK_IMPORTED_MODULE_1__["StyleguideSelectHelper"].toggleSelect(select);
    }); // apply keyboard events to custom select

    document.addEventListener('keydown', function (event) {
      _StyleguideSelectHelper__WEBPACK_IMPORTED_MODULE_1__["StyleguideSelectHelper"].handleSelectNavigationKeypressDown(select, event);
      _StyleguideSelectHelper__WEBPACK_IMPORTED_MODULE_1__["StyleguideSelectHelper"].handleSelectNavigationKeypressUp(select, event);
      _StyleguideSelectHelper__WEBPACK_IMPORTED_MODULE_1__["StyleguideSelectHelper"].handleSelectNavigationKeypressEnter(select, event);
      _StyleguideSelectHelper__WEBPACK_IMPORTED_MODULE_1__["StyleguideSelectHelper"].handleSelectNavigationKeypressEscape(select, event);
    }); // simulate select focus

    nativeSelectElement.addEventListener('focus', function (event) {
      _StyleguideSelectHelper__WEBPACK_IMPORTED_MODULE_1__["StyleguideSelectHelper"].simulateSelectFocus(select, event);
    });
    nativeSelectElement.addEventListener('blur', function (event) {
      _StyleguideSelectHelper__WEBPACK_IMPORTED_MODULE_1__["StyleguideSelectHelper"].simulateSelectBlur(select, event);
    });
  }
};

Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["register"])('StyleguideSelect', StyleguideSelect);

/***/ }),

/***/ "./Resources/Private/Components/Atom/StyleguideSelect/StyleguideSelectHelper.js":
/*!**************************************************************************************!*\
  !*** ./Resources/Private/Components/Atom/StyleguideSelect/StyleguideSelectHelper.js ***!
  \**************************************************************************************/
/*! exports provided: StyleguideSelectHelper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StyleguideSelectHelper", function() { return StyleguideSelectHelper; });
...
/* harmony import */ var _Javascript_Utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../Javascript/Utils */ "./Resources/Private/Javascript/Utils.js");
/* harmony import */ var _Javascript_Polyfills__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../Javascript/Polyfills */ "./Resources/Private/Javascript/Polyfills.js");
/* harmony import */ var _Javascript_Polyfills__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_Javascript_Polyfills__WEBPACK_IMPORTED_MODULE_4__);
...
var StyleguideSelectHelper =
/*#__PURE__*/
function () {
  function StyleguideSelectHelper() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, StyleguideSelectHelper);
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(StyleguideSelectHelper, null, [{
    key: "buildFormCustomSelect",
     ...
     */
    value: function buildFormCustomSelect(nativeSelectElement) {
      var submitFormOnSelect = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      var options = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_3__["findAll"])('option', nativeSelectElement);
      ...
      var parentForm = submitFormOnSelect ? nativeSelectElement.closest('form') : false; // create custom select

      var select = document.createElement('DIV');
      select.setAttribute('class', "".concat(StyleguideSelectHelper.classPrefix, "Items"));
      ...
      var _loop = function _loop(j) {
        ...
        fakeOption.addEventListener('mousedown', function (e) {
          e.preventDefault();
        });
        fakeOption.addEventListener('click', function (e) {
          ...
          var previousSibling = e.currentTarget.parentNode.previousSibling;
          var formCustomSelectEqualSelected = e.currentTarget.parentNode.getElementsByClassName("".concat(StyleguideSelectHelper.classPrefix, "EqualSelected"));
          ...
          if (nativeSelectElement.options[j].dataset.reset) {
            ...
            for (var k = 0; k < formCustomSelectEqualSelected.length; k++) {
            ...
            if (nativeSelectElement.options[j].innerHTML === e.currentTarget.innerHTML) {
              ...
              for (var _k = 0; _k < formCustomSelectEqualSelected.length; _k++) {
                formCustomSelectEqualSelected[_k].removeAttribute('class');
              }

              e.currentTarget.setAttribute('class', "".concat(StyleguideSelectHelper.classPrefix, "EqualSelected"));
    ...
    key: "buildFormCustomSelectLabel",
    value: function buildFormCustomSelectLabel(nativeSelectElement, autoSuggest) {
      var fakeSelectedLabel = document.createElement('DIV');
      var value = nativeSelectElement.options[nativeSelectElement.selectedIndex].innerHTML.trim();
      fakeSelectedLabel.classList.add("".concat(StyleguideSelectHelper.classPrefix, "Selected"));

      if (autoSuggest) {
        var autoSuggestInput = document.createElement('input');
        autoSuggestInput.classList.add("".concat(StyleguideSelectHelper.classPrefix, "AutosuggestInput"));
        ...
        inputLabel.classList.add("".concat(StyleguideSelectHelper.classPrefix, "InputLabel"));
        setTimeout(function () {
          fakeSelectedLabel.style.width = "".concat(inputLabel.clientWidth, "px");
        }, 20);
      } else {
    ...
    key: "simulateSelectFocus",
    value: function simulateSelectFocus(select, event) {
    ...
    key: "simulateSelectBlur",
    value: function simulateSelectBlur(select, event) {
      if (select.classList.contains("".concat(StyleguideSelectHelper.classPrefix, "Opened"))) {
        StyleguideSelectHelper.toggleSelect(select);
      }
    }
    /**
    ...
    key: "handleSelectNavigationKeypressDown",
    value: function handleSelectNavigationKeypressDown(select, event) {
      if (event.isComposing || event.keyCode !== 40 || !select.classList.contains("".concat(StyleguideSelectHelper.classPrefix, "Opened"))) {
        return;
      }

      event.preventDefault();
      var firstOption = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_3__["find"])(".".concat(StyleguideSelectHelper.classPrefix, "Items div"), select);

      if (!Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_3__["find"])(".".concat(StyleguideSelectHelper.classPrefix, "Active"), select)) {
        firstOption.classList.add("".concat(StyleguideSelectHelper.classPrefix, "Active"));
      } else {
        var selectedOption = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_3__["find"])(".".concat(StyleguideSelectHelper.classPrefix, "Active"), select);

        if (!selectedOption.nextSibling) {
          return;
        }

        selectedOption.nextSibling.classList.add("".concat(StyleguideSelectHelper.classPrefix, "Active"));
        selectedOption.classList.remove("".concat(StyleguideSelectHelper.classPrefix, "Active"));
    ...
    key: "handleSelectNavigationKeypressUp",
    value: function handleSelectNavigationKeypressUp(select, event) {
      if (event.isComposing || event.keyCode !== 38 || !(select.classList.contains("".concat(StyleguideSelectHelper.classPrefix, "Opened")) && Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_3__["find"])(".".concat(StyleguideSelectHelper.classPrefix, "Active"), select))) {
        return;
      }

      event.preventDefault();
      var firstOption = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_3__["find"])('.selectItems div', select);
      var selectedOption = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_3__["find"])(".".concat(StyleguideSelectHelper.classPrefix, "Active"), select);
      ...
      selectedOption.previousSibling.classList.add("".concat(StyleguideSelectHelper.classPrefix, "Active"));
      selectedOption.classList.remove("".concat(StyleguideSelectHelper.classPrefix, "Active"));
    ...
    key: "handleSelectNavigationKeypressEnter",
    value: function handleSelectNavigationKeypressEnter(select, event) {
      if (event.isComposing || event.keyCode !== 13) {
        return;
      }

      if (select.classList.contains("".concat(StyleguideSelectHelper.classPrefix, "Opened")) && Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_3__["find"])(".".concat(StyleguideSelectHelper.classPrefix, "Active"), select)) {
        event.preventDefault();
        var selectedOption = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_3__["find"])(".".concat(StyleguideSelectHelper.classPrefix, "Active"), select);
    ...
    key: "handleSelectNavigationKeypressEscape",
    value: function handleSelectNavigationKeypressEscape(select, event) {
    ...
    key: "handleAutoSuggestInput",
    value: function handleAutoSuggestInput(fakeOptions, select, autoSuggestInput) {
      var fakeOptionsOnSuggest = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_3__["findAll"])('div', select);
      var value = autoSuggestInput.value;

      if (!value) {
        fakeOptions.forEach(function (element) {
      ...
      var autoSuggestResult = fakeOptions.filter(function (h) {
        return keywords.every(function (k) {
          return h.textContent.toLowerCase().includes(k.toLowerCase());
        });
      });
      fakeOptionsOnSuggest.forEach(function (element) {
        select.removeChild(element);
      });
      autoSuggestResult.forEach(function (element) {
        select.appendChild(element);
      });
      StyleguideSelectHelper.setSelectFlyOutHeight(select);
    }
    ...
    key: "handleAutoSuggestBlur",
    value: function handleAutoSuggestBlur(fakeOptions, select, autoSuggestInput) {
      var fakeOptionsOnSuggest = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_3__["findAll"])('div', select);
      fakeOptionsOnSuggest.forEach(function (element) {
        select.removeChild(element);
      });
    ...
    key: "toggleSelect",
    value: function toggleSelect(select) {
      var allSelects = document.querySelectorAll(".".concat(StyleguideSelectHelper.classPrefix, "Opened"));
      var keyboardSelectedSelect = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_3__["find"])(".".concat(StyleguideSelectHelper.classPrefix, "Active"), select);
      var autoSuggest = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_3__["find"])(".".concat(StyleguideSelectHelper.classPrefix, "AutosuggestInput"), select.previousElementSibling);

      if (select.classList.toggle("".concat(StyleguideSelectHelper.classPrefix, "Opened"))) {
        StyleguideSelectHelper.setSelectFlyOutHeight(select);

        for (var element = 0; element < allSelects.length; element++) {
          if (allSelects[element] !== select) {
            allSelects[element].classList.remove("".concat(StyleguideSelectHelper.classPrefix, "Opened"));
            allSelects[element].previousSibling.classList.remove("".concat(StyleguideSelectHelper.classPrefix, "ArrowActive"));
          }
        }
      ...
      select.previousSibling.classList.toggle("".concat(StyleguideSelectHelper.classPrefix, "ArrowActive"));

      if (keyboardSelectedSelect) {
        keyboardSelectedSelect.classList.remove("".concat(StyleguideSelectHelper.classPrefix, "Active"));
      }
    }
    /**
     * closes the select
    ...
    value: function closeSelect() {
      var openSelect = document.querySelector(".".concat(StyleguideSelectHelper.classPrefix, "Opened"));
      document.removeEventListener('click', StyleguideSelectHelper.closeSelect);

      if (openSelect) {
        openSelect.classList.remove("".concat(StyleguideSelectHelper.classPrefix, "Opened"));
        openSelect.previousSibling.classList.remove("".concat(StyleguideSelectHelper.classPrefix, "ArrowActive"));
      }
    }
    /**
    ...
    key: "setSelectFlyOutHeight",
    value: function setSelectFlyOutHeight(select) {
      select.removeAttribute('style');
      var selectLabel = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_3__["find"])(".".concat(StyleguideSelectHelper.classPrefix, "Selected"), select.parentNode);
      var selectDropdownMaxHeight = window.innerHeight - selectLabel.getBoundingClientRect().top - selectLabel.offsetHeight;
      var height = selectLabel.offsetHeight * select.childElementCount;
      var selectDropdownMaxHeightFixed = select.offsetHeight > selectDropdownMaxHeight;
      var cssHeightAndMaxHeight = "height:".concat(height + 2, "px;max-height:").concat(selectDropdownMaxHeightFixed + 2, "px;");
      select.setAttribute('style', cssHeightAndMaxHeight);
    }
  }]);

  return StyleguideSelectHelper;
}();

_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(StyleguideSelectHelper, "classPrefix", 'styleguideSelect');



/***/ }),

/***/ "./Resources/Private/Components/Atom/ViewportNavigation/ViewportNavigation.js":
/*!************************************************************************************!*\
  !*** ./Resources/Private/Components/Atom/ViewportNavigation/ViewportNavigation.js ***!
  \************************************************************************************/
/*! no exports provided */
...
var ViewportNavigation = function ViewportNavigation(el) {
  var iframes = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["findAll"])('.fluidStyleguideComponent');
  var viewPortNavItem = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["findAll"])('.viewportItem', el);
  var rulerOption = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["find"])('.rulerOption', el);
  var dropdownLabel = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["find"])('.dropdownLabel', el);
  var listView = el.dataset.listview;
  viewPortNavItem.forEach(function (item) {
    var viewPortValue = item.dataset.viewport;
    item.addEventListener('click', function () {
      Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["find"])('.active', el).classList.remove('active');
      ...
      viewPortNavItem.forEach(function (inner) {
...
Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["register"])('ViewportNavigation', ViewportNavigation);

/***/ }),

/***/ "./Resources/Private/Components/Molecule/EditFixtures/EditFixtures.js":
/*!****************************************************************************!*\
  !*** ./Resources/Private/Components/Molecule/EditFixtures/EditFixtures.js ***!
  \****************************************************************************/
/*! no exports provided */
...
var EditFixtures = function EditFixtures(el) {
  var form = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["find"])('form', el);
  var inputs = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["findAll"])('.editFixturesInput', el);
  var checkboxes = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["findAll"])('.editFixturesCheckbox', el);
...
Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["register"])('EditFixtures', EditFixtures);

/***/ }),

/***/ "./Resources/Private/Components/Organism/StyleguideToolbar/StyleguideToolbar.js":
/*!**************************************************************************************!*\
  !*** ./Resources/Private/Components/Organism/StyleguideToolbar/StyleguideToolbar.js ***!
  \**************************************************************************************/
/*! no exports provided */
...
var StyleguideToolbar = function StyleguideToolbar(el) {
  var toolbarOpener = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["find"])('.toolbarOpener', el);
  var tabOpeners = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["findAll"])('.tabOpener', el);
  var tabContents = Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["findAll"])('.tabContent', el);
  el.style.bottom = "-".concat(el.clientHeight - 16, "px");
  toolbarOpener.addEventListener('click', function () {
    if (!el.classList.toggle('open')) {
      ...
      tabOpeners.forEach(function (opener, openerIndex) {
        if (!openerIndex) {
  ...
  tabOpeners.forEach(function (opener, openerIndex) {
    opener.addEventListener('click', function () {
      Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["find"])('.tabOpener.active').classList.remove('active');
      Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["find"])('.tabContent.active').classList.remove('active');
      tabContents.forEach(function (content, contentIndex) {
...
Object(_Javascript_Utils__WEBPACK_IMPORTED_MODULE_0__["register"])('StyleguideToolbar', StyleguideToolbar);

/***/ }),

/***/ "./Resources/Private/Javascript/Polyfills.js":
/*!***************************************************!*\
  !*** ./Resources/Private/Javascript/Polyfills.js ***!
  \***************************************************/
/*! no static exports found */
...
/* harmony import */ var iframe_resizer_js_iframeResizer__WEBPACK_IMPORTED_MODULE_129__ = __webpack_require__(/*! iframe-resizer/js/iframeResizer */ "./node_modules/iframe-resizer/js/iframeResizer.js");
/* harmony import */ var iframe_resizer_js_iframeResizer__WEBPACK_IMPORTED_MODULE_129___default = /*#__PURE__*/__webpack_require__.n(iframe_resizer_js_iframeResizer__WEBPACK_IMPORTED_MODULE_129__);
/* harmony import */ var _Components_Atom_StyleguideRefreshIFrame_StyleguideRefreshIFrame__WEBPACK_IMPORTED_MODULE_130__ = __webpack_require__(/*! ../Components/Atom/StyleguideRefreshIFrame/StyleguideRefreshIFrame */ "./Resources/Private/Components/Atom/StyleguideRefreshIFrame/StyleguideRefreshIFrame.js");
/* harmony import */ var _Components_Atom_StyleguideRefreshIFrame_StyleguideRefreshIFrame__WEBPACK_IMPORTED_MODULE_130___default = /*#__PURE__*/__webpack_require__.n(_Components_Atom_StyleguideRefreshIFrame_StyleguideRefreshIFrame__WEBPACK_IMPORTED_MODULE_130__);
/* harmony import */ var _Components_Atom_StyleguideSelect_StyleguideSelect__WEBPACK_IMPORTED_MODULE_131__ = __webpack_require__(/*! ../Components/Atom/StyleguideSelect/StyleguideSelect */ "./Resources/Private/Components/Atom/StyleguideSelect/StyleguideSelect.js");
/* harmony import */ var _Components_Organism_StyleguideToolbar_StyleguideToolbar__WEBPACK_IMPORTED_MODULE_132__ = __webpack_require__(/*! ../Components/Organism/StyleguideToolbar/StyleguideToolbar */ "./Resources/Private/Components/Organism/StyleguideToolbar/StyleguideToolbar.js");
/* harmony import */ var _Components_Atom_StyleguideScrollTop_StyleguideScrollTop__WEBPACK_IMPORTED_MODULE_133__ = __webpack_require__(/*! ../Components/Atom/StyleguideScrollTop/StyleguideScrollTop */ "./Resources/Private/Components/Atom/StyleguideScrollTop/StyleguideScrollTop.js");
/* harmony import */ var _Components_Atom_ViewportNavigation_ViewportNavigation__WEBPACK_IMPORTED_MODULE_134__ = __webpack_require__(/*! ../Components/Atom/ViewportNavigation/ViewportNavigation */ "./Resources/Private/Components/Atom/ViewportNavigation/ViewportNavigation.js");
/* harmony import */ var _Components_Molecule_EditFixtures_EditFixtures__WEBPACK_IMPORTED_MODULE_135__ = __webpack_require__(/*! ../Components/Molecule/EditFixtures/EditFixtures */ "./Resources/Private/Components/Molecule/EditFixtures/EditFixtures.js");
...
/***/ "./Resources/Private/Javascript/Utils.js":
/*!***********************************************!*\
  !*** ./Resources/Private/Javascript/Utils.js ***!
  \***********************************************/
/*! exports provided: find, findAll, register */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var register = function register(name, component) {
  document.addEventListener('DOMContentLoaded', function () {
    findAll("[data-component=".concat(name, "]")).forEach(function (el) {
      return component(el);
    });
  });
};
